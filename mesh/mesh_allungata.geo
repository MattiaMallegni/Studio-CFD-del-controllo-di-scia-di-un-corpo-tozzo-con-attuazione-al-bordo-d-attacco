...
D = 1; // Altezza caratteristica del corpo (resta 1)
L_body = 2; // NUOVO: Lunghezza del corpo (passa da 1 a 2)
...
X_center_body = 0.5*L_body; // MODIFICATO: Il centro ora dipende dalla nuova lunghezza
Y_center_body = 0; 
...
// Punti Corpo Centrale (Prefisso 1xx)
Point(104) = {cx, cy_top, 0, lcBody};
Point(103) = { L_body, D/2, 0, lcBody}; // MODIFICATO: La X ora è L_body (cioè 2)
...
// Punti Box Intermedio (Prefisso 3xx)
Point(303) = {Xmax_small_sq, Ymax_small_sq, 0, lcIntermediate};
Point(304) = {Xmin_small_sq, Ymax_small_sq, 0, lcIntermediate};
Point(314) = {Xmin_small_sq, 0.9, 0, lcIntermediate};      
Point(351) = {Xmin_small_sq, 1.4136, 0, lcIntermediate};   
Point(352) = {Xmin_small_sq, 1.3316, 0, lcIntermediate};   

// Punti Box Esterno (Prefisso 6xx)
Point(603) = {Xmax_large_rect, Ymax_large_rect, 0, lcMax};
Point(604) = {Xmin_large_rect, Ymax_large_rect, 0, lcMax};
Point(614) = {Xmin_large_rect, 0.9, 0, lcMax};      
Point(651) = {Xmin_large_rect, 1.4136, 0, lcMax};   
Point(652) = {Xmin_large_rect, 1.3316, 0, lcMax};   
...
// Punti Asse Simmetria y=0 (Prefisso 901-906)
Point(901) = {0, 0, 0, lcBody};
Point(902) = {L_body, 0, 0, lcBody}; // MODIFICATO: La X ora è L_body (cioè 2)
...
// Punti Aggiunti Manualmente (Prefisso 907-915)
...
Point(910) = {X_center_body, D/2, 0, lcBody}; // MODIFICATO: Si sposta con il nuovo centro
Point(911) = {X_center_body, Ymax_small_sq, 0, lcIntermediate};
Point(912) = {X_center_body, Ymax_large_rect, 0, lcMax};
Point(913) = {13.8, 0, 0, lcIntermediate};
...
Physical Curve("actuatorSlot_top", 6) = {210, 1001}; // Zona di attuazione sopra
Physical Curve("actuatorSlot_bottom", 8) = {1062, 1067}; // Zona di attuazione sotto
...
Transfinite Curve {203} = 35 Using Progression 1.08;
Transfinite Curve {504} = 35 Using Progression 1;
...
Transfinite Curve {1008} = 35 Using Progression 1.08;
Transfinite Curve {1005} = 35 Using Progression 1;
Transfinite Curve {1004} = 25 Using Progression 1.1;
Transfinite Curve {1006} = 35 Using Progression 1;
Transfinite Curve {809} = 35 Using Progression 1;
...
Transfinite Curve {1073} = 35 Using Progression 1/1.08; // Mirror di 203
Transfinite Curve {1071} = 35 Using Progression 1;  // Mirror di 504
...
Transfinite Curve {1078} = 35 Using Progression 1.08; // Mirror di 1008
Transfinite Curve {1076} = 35 Using Progression 1;  // Mirror di 1005
Transfinite Curve {1082} = 25 Using Progression 1/1.1; // Mirror di 1004
Transfinite Curve {1081} = 35 Using Progression 1;  // Mirror di 1006
Transfinite Curve {1086} = 35 Using Progression 1;  // Mirror di 809
...
//+
Hide {
  Point{104}; Point{989}; Point{1265}; Point{1417}; Curve{299}; 
}
